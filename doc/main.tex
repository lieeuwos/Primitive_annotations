...
In this research we focus on the classification group to give room to new algorithms
This thesis focuses on the selection of algorithms in the classification group. 
...
\subsubsection{Noisy data}
injection of std into numerical datasets done in figure \ref{fig:predNonCatFeat}. In figures \ref{fig:predNoisyFeaturesRF}, \ref{fig:predNoisyFeaturesKNN}, \ref{fig:predNoisyFeaturesSGD}, \ref{fig:predNoisyFeaturesADA}, \ref{fig:predNoisyFeaturesSVC}, \ref{fig:predNoisyFeaturesGNB}, \ref{fig:predNoisyFeaturesBNB}, \ref{fig:predNoisyFeaturesGBC} the individual results of each classifier is shown.
\begin{figure}[h] 
	\centering
	\includegraphics[
	width=0.65\textwidth
