...
\begin{figure}[h] %use t for top of page instead of h for here
	...
	\caption{FlowChartML scikit-learn for any dataset which machine learning algorithm to choose}
	\label{fig:FlowChart}
\end{figure}
