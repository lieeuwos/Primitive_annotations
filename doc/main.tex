...
\begin{figure}[h] %use t for top of page instead of h for here
	...
	\caption{FlowChart with the different machine learning algorithms in the sklearn library \ref{scikit-learn}}
	\label{fig:FlowChart}
\end{figure}
...
This thesis focuses on the selection of algorithms in the classification group. The work of Joaquin introduces the properties for classifiers
