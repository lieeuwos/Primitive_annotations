...
For different parts of the research different datasets are chosen. There is overlap between the datasets but the chosen datasets can have a large impact on shown results. Most results are shown as an average result of the datasets
...
For the bias variance calculation it is import to gain multiple predictions for the same value and with bootstrapping this can be easily achieved. The downside however can be an increased bias and reduced variance.
...
\subsubsection{Nuemrical datasets}
