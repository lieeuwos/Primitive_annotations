...
\begin{tabular}{ p{0.20\linewidth} p{0.7437\linewidth} }
	...
	numerical & exact values, more uniquely than a category.\\ [1ex]	
...
Categorical datasets hold only 
...
\paragraph{categorical features}
 replacing with categorical distribution. 
\paragraph{numerical features}
adding standard deviaton

\section{Experimental Results} \label{Chapter4}


\subsection{Scalability}
All results with a duration axis. 
