...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		...
		\caption{features removed randomly and features  redundantly duplicated}
		\label{fig:FeatMan}
	\end{subfigure}
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[
		...
		\caption{features removed randomly and features  redundantly duplicatedd with a log scale}
		\label{fig:FeatManLog}
	\end{subfigure}
	\caption{feature manipulation from removing to adding features.}
	\label{fig:FeatManTot}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{features removed randomly and features  redundantly duplicated slope of \ref{fig:FeatMan}}
	...
	\caption{features removed randomly and features  redundantly duplicated absolute slope calculated of the clean dataset (values from  \ref{fig:FeatMan}) }
	\label{fig:FeatManSlope1}
	\end{subfigure}
	\caption{feature manipulation slope from removing to adding features.}
	\label{fig:FeatManTot}
\end{figure}
...
\begin{figure}[h] 
	...
	\caption{features removed randomly and features  redundantly duplicated absolute slope calculated of the clean dataset with a log scale (values from  \ref{fig:FeatMan})}
...
\begin{table}[h]
	...
	\caption{all change in predictive accuracy in adding certain kind of features(results from \ref{fig:predNonCatAddFeat})}\label{table:fluc}
\end{table}
